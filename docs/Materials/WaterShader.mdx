...
<ButtonLinkdownload link="/WaterDefaultAssets.unitypackage" title="Press here to download" filename="WaterDefaultAssets.unitypackage" target="_blank" rel="noreferrer"/>
